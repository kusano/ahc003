...
def objective(trial):
  ...
  #hv_min = trial.suggest_float("hv_min", 0, 3000)
  hv_min = trial.suggest_float("hv_min", 0, 2000)
  #hv_max = trial.suggest_float("hv_max", 5000, 10000)
  hv_max = trial.suggest_float("hv_max", 8000, 10000)
  #hv_init = trial.suggest_float("hv_init", hv_min, hv_max)
  #hv_init = trial.suggest_float("hv_init", max(0, hv_min), 4000)
  hv_init = trial.suggest_float("hv_init", 2000, 4000)
  #hv_learn_rate = trial.suggest_float("hv_learn_rate", 0, 1)
  #hv_learn_rate = trial.suggest_float("hv_learn_rate", 0.1, 0.8)
  hv_learn_rate = trial.suggest_float("hv_learn_rate", 0.3, 0.5)
  ...
  #delta_learn_rate = trial.suggest_float("delta_learn_rate", 0.05, 0.3)
  delta_learn_rate = trial.suggest_float("delta_learn_rate", 0.05, 0.15)
